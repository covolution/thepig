	...
	<body>
		...
		<div id="show-order" class="content scaffold-show" role="main">
			...
			<ol class="property-list order">
				...
				<g:if test="${orderInstance?.dueAt}">
				<li class="fieldcontain">
					<span id="dueAt-label" class="property-label"><g:message code="order.dueAt.label" default="Due At" /></span>
					
						<span class="property-value" aria-labelledby="dueAt-label"><g:fieldValue bean="${orderInstance}" field="dueAt"/></span>
