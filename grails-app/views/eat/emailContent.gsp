...
<body>
	<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
		<tr>
			<td>Dear ${theHost.forename},</td>
		</tr>
		<tr>
			<td>${theUser.forename} ${theUser.surname} would like to join you for the feast. Here's what they would like:</td>
		</tr>		
		<tr>
			<td>
				<g:each in="${theMeal.portions.ingredient}" var="ingredient">
