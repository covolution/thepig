	...
	<body>
		...
		<div id="show-ingredient" class="content scaffold-show" role="main">
			...
			<ol class="property-list ingredient">
				...
				<g:if test="${ingredientInstance?.ingredientGroup}">
				<li class="fieldcontain">
					<span id="ingredientGroup-label" class="property-label"><g:message code="ingredient.ingredientGroup.label" default="Ingredient Group" /></span>
					
						<span class="property-value" aria-labelledby="ingredientGroup-label"><g:fieldValue bean="${ingredientInstance}" field="ingredientGroup"/></span>
