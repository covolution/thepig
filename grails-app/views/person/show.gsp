	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.forename}">
				<li class="fieldcontain">
					<span id="forename-label" class="property-label"><g:message code="person.forename.label" default="Forename" /></span>
					
						<span class="property-value" aria-labelledby="forename-label"><g:fieldValue bean="${personInstance}" field="forename"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<sec:ifAllGranted roles="ROLE_ADMIN">
						<g:link class="edit" action="makeAdmin" id="${personInstance?.id}">Make Admin</g:link>
					</sec:ifAllGranted>
				</fieldset>
			</g:form>
		</div>
